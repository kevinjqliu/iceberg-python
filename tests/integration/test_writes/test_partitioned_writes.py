...
def test_query_filter_null_partitioned(
    ...
    part_cols = ['int', 'bool', 'string', "string_long", "long", "float", "double", "date", 'timestamp', 'timestamptz', 'binary']
...
def test_query_filter_appended_null_partitioned(
    ...
    part_cols = ['int', 'bool', 'string', "string_long", "long", "float", "double", "date", "timestamptz", "timestamp", "binary"]
    for part_col in part_cols:
        # Given
